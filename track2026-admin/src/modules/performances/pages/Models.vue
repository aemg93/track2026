...
import ModelsTable from '@/modules/performances/components/ModelsTable.vue'
import ModelsFilters from '@/modules/performances/components/ModelsFilters.vue'
...
const handleDelete = async (model) => {
  ...
  try {
    await api.delete(`/performances/${model.id}`)
