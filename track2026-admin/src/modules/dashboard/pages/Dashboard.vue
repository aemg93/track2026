        ...
        >
            ...
            >
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <div class="bg-blue-500/10 border border-blue-500/20 rounded-2xl px-6 py-4">

                        <p class="text-gray-400 text-sm">Modelos</p>
                    ...
                    <div class="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl px-6 py-4">
